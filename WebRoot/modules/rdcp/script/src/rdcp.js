...
var rdcp = {
     ...
     * 默认加载模块
     */
    defaultLoadModules: [ 'jqueryuploader', 'rdcpui' ],
    defaultLoadModules2: [ 'jqueryuploader', 'rdcpui2' ],
    defaultLoadModules3: [ 'jqueryuploader', 'rdcpui3' ],
    /**
     * rdcp所有模块定义<br>
    ...
    rdcpModules: {
        jquery: {
            js: ['lib/jquery/jquery.tmpl.min.js' ]
        },
        locale: {
        ...
        easyui: {
            ...
            css: [ 'lib/easyui/jquery-easyui-1.3.3/themes/gray/easyui.css',
                'lib/easyui/jquery-easyui-1.3.3/themes/icon.css' ],
        ...
        easyui2: {
            js: [ 'lib/easyui/jquery-easyui-1.3.3/jquery.easyui.min.js',
                'lib/easyui/jquery-easyui-1.3.3/plugins/jquery.combobox-bugfixed.js',
                'lib/easyui/jquery-easyui-1.3.3/locale/easyui-lang-zh_CN.js' ],
            css: [ 'lib/easyui/jquery-easyui-1.3.3/themes/icon.css' ],
            dependencies: [ 'rdcpcore' ],
            onload: function (p) {
                jQuery.parser.parse();
            }
        ...
        rdcpui2: {
            js: [ 'src/ui/rdcp.window.js', 'src/ui/rdcp.tree.js', 'src/ui/rdcp.grid.js', 'src/ui/rdcp.dateBox.js', 'src/ui/rdcp.form.js',
                'src/ui/rdcp.comboBox.js', 'src/ui/rdcp.tips.js', 'src/ui/rdcp.menu.js', 'src/ui/rdcp.menu.lowerNavMenuBuilder.js',
                'src/ui/rdcp.mask.js', 'src/ui/rdcp.messages.js','src/ui/rdcp.dialog.js'],
            dependencies: [ 'locale', 'rdcpcore', 'easyui2' ]
        },
        rdcpui3: {
            js: [ 'src/ui/rdcp.window.js', 'src/ui/rdcp.tree.js', 'src/ui/rdcp.grid.js', 'src/ui/rdcp.dateBox.js', 'src/ui/rdcp.form.js',
                'src/ui/rdcp.comboBox.js', 'src/ui/rdcp.tips.js', 'src/ui/rdcp.menu.js', 'src/ui/rdcp.menu.lowerNavMenuBuilder.js',
                'src/ui/rdcp.mask.js', 'src/ui/rdcp.messages.js','src/ui/rdcp.dialog.js'],
            dependencies: [ 'locale', 'rdcpcore', 'easyui3' ]
        },
        highcharts: {
...
var onloads = [];
rdcp.ready = function (onload,defaultLoadModules) {
    onloads.push(onload);
    window.onload = function () {
        rdcp.loadModules({
            modules: defaultLoadModules==undefined?rdcp.defaultLoadModules:defaultLoadModules,
            onload: function () {
