...
_43(this);
var _4c=$.fn.combobox.parseData(this);
if(_4c.length){
_28(this,_4c);
}
}
...
var _4d=jq.combo("options");
return $.extend($.data(jq[0],"combobox").options,{originalValue:_4d.originalValue,disabled:_4d.disabled,readonly:_4d.readonly});
},getData:function(jq){
...
if(_51.multiple){
$(this).combobox("setValues",_51.originalValue);
}else{
$(this).combobox("setValue",_51.originalValue);
}
});
},loadData:function(jq,_52){
return jq.each(function(){
_28(this,_52);
});
...
},select:function(jq,_53){
return jq.each(function(){
_11(this,_53);
});
},unselect:function(jq,_54){
return jq.each(function(){
_19(this,_54);
});
}};
$.fn.combobox.parseOptions=function(_55){
var t=$(_55);
return $.extend({},$.fn.combo.parseOptions(_55),$.parser.parseOptions(_55,["valueField","textField","mode","method","url"]));
};
$.fn.combobox.parseData=function(_56){
var _57=[];
var _58=$(_56).combobox("options");
$(_56).children("option").each(function(){
var _59={};
_59[_58.valueField]=$(this).attr("value")!=undefined?$(this).attr("value"):$(this).html();
_59[_58.textField]=$(this).html();
_59["selected"]=$(this).attr("selected");
_57.push(_59);
});
return _57;
};
...
return row[_5a.textField].indexOf(q)==0;
},formatter:function(row){
var _5b=$(this).combobox("options");
return row[_5b.textField];
},loader:function(_5c,_5d,_5e){
var _5f=$(this).combobox("options");
if(!_5f.url){
return false;
}
$.ajax({type:_5f.method,url:_5f.url,data:_5c,dataType:"json",success:function(_60){
_5d(_60);
},error:function(){
_5e.apply(this,arguments);
}});
},loadFilter:function(_61){
return _61;
},onBeforeLoad:function(_62){
},onLoadSuccess:function(){
},onLoadError:function(){
},onSelect:function(_63){
},onUnselect:function(_64){
}});
})(jQuery);
