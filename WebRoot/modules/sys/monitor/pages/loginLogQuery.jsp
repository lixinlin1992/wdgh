...
<head>
    ...
    <script type="text/javascript" src="!sys/monitor/~/scripts/loginLogQuery.js"></script>
    <script type="text/javascript">
    	rdcp.ready(function(){
    		rdcp.grid("loginLogGrid","!sys/monitor/~query/Q_LOGINLOG_LIST","loginLogFormID",loginLogQueryParams);
    	});
    </script>
</head>
<body>
<div class="SR_Space">
    ...
    <div class="SR_moduleBox">
        <div class="SR_moduleTitle">用户登录日志查询</div>
    ...
    <div class="SR_searchTableBox">
        <form id="loginLogFormID" name="loginLogForm" onsubmit="rdcp.grid.reload('loginLogGrid');return false;"
              method="post">
            <table>
                <tr>
                    ...
                    <td><a class="SR_moduleSearch" onmouseover="this.className='SR_moduleSearchHover';"
                           onMouseOut="this.className='SR_moduleSearch'" href="javascript://" onclick="rdcp.grid.reload('loginLogGrid');"></a>
                        </td>
                </tr>
            </table>
