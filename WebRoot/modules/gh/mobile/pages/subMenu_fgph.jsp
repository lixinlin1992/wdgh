...
<head>
    ...
    <script type="text/javascript">
      ...
      var page = 1;
      rdcp.ready(function(){
        rdcp.request("!gh/mobile/~query/Q_LOAD_SUBMENU_LIST_FGPH",{"code_table":code_table,"code_num":code_num,"rows":rows,"page":page},function(data){
          var rows = data.body.rows;
          $("#header_title").append(rows[0].HEADER_TITLE);
          for(var i=0;i<rows.length;i++){
            var html = "<li><div class='col-xs-12 col-sm-6 col-md-6'>";
            html += "<a  class='c46693'>"+rows[i].TITLE+"投稿量:"+rows[i].COU+"</a>";
            html += "</div></li>";
