...
<head>
    ...
    <script type="text/javascript" src="!gh/wechat/~/scripts/W_suzhituozhan.js"></script>
</head>
...
<div class="warpe">
    ...
    <div class="tabs my_tab4">
        ...
        <a href="!gh/wechat/~/pages/W_suzhituozhan.jsp" hidefocus="true" class="active">素质拓展</a>
    </div>
