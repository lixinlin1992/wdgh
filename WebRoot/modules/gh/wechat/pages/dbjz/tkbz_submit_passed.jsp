...
%>
	<script type="text/javascript">
        rdcp.ready(function(){});
        //var account = '00008629';
		var account = '<%=member.getAccount()%>';
        var status = '10';
        var con = "";
        rdcp.ready(function () {

            rdcp.request("!gh/wechat/~java/Dbjz.tkbzSubmit", {"number": account,"status":status}, function (data) {
                if (data.body.total == 0) {
                    con += "<div class='M_no'><p><img src='!gh/wechat/~/img/icon_bq.png'>您还没有相关申请通过审核</p>";
                    $("#wrape").html(con);
                }else
                {
