...
function loadData(){
    rdcp.request("!gh/wechat/~query/Q_LOAD_INFO_LIST",{"table_name":"BI_SCHOOL_CULTURE","type":"1"},function(data){
        var rows = data.body.rows;
        for(var i=0;i<rows.length;i++){
            var html = "<div class='postall'>";
            html += "<a href='!gh/wechat/~/pages/W_activityIntroduction.jsp?culture_id="+rows[i].ID+"'><div class='post_t'><img src='!gh/wechat/~/img/icon_fk.png'>";
