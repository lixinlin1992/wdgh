...
<script type="text/javascript">
    ...
    function sureBtn() {
        ...
        if (content == "" || content == null) {
            $.messager.alert('提示', '请编辑政策法规内容！', 'info');
            return false;
        }
        if (option == "add") {
            rdcp.form.submit("schoolCultureForm", {
                url: "!gh/info/~query/Q_ADD_POLICY_REGULATION",
                success: function (data) {
                    $.messager.alert('提示', '政策法规信息发布成功！', 'info',function () {
                        cancel();
                    });
                }
            }, {"mask": true});
            ...
            rdcp.form.submit("schoolCultureForm", {
                url: "!gh/info/~query/Q_UPDATE_POLICY_REGULATION" ,
                success: function (data) {
                    $.messager.alert('提示', '政策法规信息修改成功！', 'info',function () {
                        cancel();
                    });
                }
            }, {"mask": true});
    ...
    {
        if (option == "add") {
            CloseTab("addPolicyRegulation", "发布政策法规");
        }
        else if (option == "edit"){
            CloseTab("editPolicyRegulation", "修改政策法规");
        }
