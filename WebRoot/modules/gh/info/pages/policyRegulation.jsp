...
<head>
    ...
    <script type="text/javascript" src="!gh/info/~/scripts/policyRegulation.js"></script>
...
<div class="SR_Space">
    ...
    <div class="SR_moduleBox">
        <div class="SR_moduleTitle">政策法规</div>
        <div class="SR_moduleRight">
            <div>
                <a class="btn_add" href="javascript:void(0);" onclick="addPolicyRegulation()" title="">发布政策法规</a>
            </div>
        </div>
    </div>
    <!--标题和一些页面功能的工具条End-->
