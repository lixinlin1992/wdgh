    ...
    <div align="center">
        ...
        <div class="SR_searchTableBox">
            <div class="barquerycontent">
                <form id="electronicPhotoForm" name="electronicPhotoForm">
...
<script type="text/javascript">
    ...
    rdcp.ready(function () {
        ...
        getParamsByPaCode("type", "BI_ELECTRONIC_PHOTO", "TYPE", function () {
            if (option == "add") {
            }
            else if (option == "edit") {
                //如果option为edit，则加载表单
                rdcp.form.load("electronicPhotoForm", "!gh/info/~query/Q_GET_ELECTRONIC_PHOTO_INFO", 'photo_id=' + photo_id, function (data) {
    ...
    function sureBtn() {
        ...
        if (option == "add") {
            rdcp.form.submit("electronicPhotoForm", {
                url: "!gh/info/~query/Q_ADD_ELECTRONIC_PHOTO",
            ...
            rdcp.form.submit("electronicPhotoForm", {
                url: "!gh/info/~query/Q_UPDATE_ELECTRONIC_PHOTO" ,
                success: function (data) {
    ...
    {
        if (option == "add") {
            CloseTab("addElectronicPhoto", "发布信息");
        }
        else if (option == "edit"){
            CloseTab("editElectronicPhoto", "修改信息");
        }
