                ...
                buildMenu = function (data) {
                    ...
                    for (var i = 0; i < data['body'].length; i++) {
                        ...
                        p.append("<li class='SR_navSecondTitle' onclick='navSecondTitleClick(\"" + _menu.id +
                                ...
                                "'><a id='a_navSecondTitle" + _menu.id + "' style='cursor: pointer;' target='page_frame_" + _menu.id + "'>" +
...
//                    }
        ...
        function navSecondTitleClick(id, name, href) {
            ...
            */
            ...
            parent.Logic.OpenTab(tabObj, id, name, href);
        }
       
        rdcp.ready(function () {
            //loadMenu(22, 2);
            /*
            rdcp.request("!sys/menu/~java/UserMenu", {time: new Date().getTime()}, function(data){
            	if(data['body'].length != 0){
            		var id = data['body'][0].id;
            		loadMenu(id, 2);
            	}
            });
            */
            timer = window.setInterval("loadfirst()", 100);
        });
