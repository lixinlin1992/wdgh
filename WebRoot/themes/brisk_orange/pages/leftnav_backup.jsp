...
//                    }
        ...
        function navSecondTitleClick(id, name, href) {
            if(href.substr(href.length-4,4)=="?old"||href.substr(href.length-4,4)=="&old"){
                parent.$("#body_page").hide();
                parent.openMenuMark(id);
                parent.$("#pageFrameContainer").show();
                parent.rdcp.menu.lowerNavMenuBuilder.openPage(id, name, href.substr(0,href.length-4), true);

                //parent.rdcp.id("body").panel("refresh", href.substr(0,href.length-4));
            }else{
                parent.$("#pageFrameContainer").hide();
                parent.$("#body_page").show();
                parent.refreshPage(id,name,href,true);
            }
