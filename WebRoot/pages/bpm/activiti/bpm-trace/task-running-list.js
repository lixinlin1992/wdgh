...
function genProcessOperateRequestStr(cellvalue, options, rowObject) {
	...
	var procDefId = rowObject['procDefId'];
...
// 初始化
$(function() {
	GRID.create("#runningList", "DS_RUNNING_LIST", task_running_list_params, "QueryForm");
});
