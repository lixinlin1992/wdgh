...
<script type="text/javascript" src="pages/bpm/activiti/bpm-trace/task-draft-list.js"></script>
</head>
<body>
	...
	<!-- 查询当前业务FORM -->
	<form name="QueryForm" onsubmit="GRID.reload('draftList');return false;">
		<!-- 草稿箱属性:isDraft -->
		<input type="hidden" id="isDraft" name="isDraft" value="true" />
