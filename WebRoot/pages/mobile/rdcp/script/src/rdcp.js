...
var rdcp = {
     ...
     * 默认加载模块
     */
    defaultLoadModules: [ 'jqueryuploader', 'rdcpui', 'numeral' ],
    ...
    rdcpModules: {
        jquery: {
            js: [ 'lib/jquery/jquery-1.8.0.min.js', 'lib/jquery/jquery.tmpl.min.js' ]
        },
        locale: {
        ...
        easyui: {
            js: [ 'lib/easyui/jquery-easyui-1.4.1/jquery.easyui.min.js',
                'lib/easyui/jquery-easyui-1.4.1/locale/easyui-lang-zh_CN.js' ],
            css: [ 'lib/easyui/jquery-easyui-1.4.1/themes/gray/easyui.css',
                'lib/easyui/jquery-easyui-1.4.1/themes/icon.css' ],
        ...
        jqueryuploader: {
            js: ["lib/jqueryuploader/js/vendor/jquery.ui.widget.js",
                ...
                'src/ui/rdcp.uploader.js'
            ],
            css: ['lib/jqueryuploader/css/jquery.fileupload.css'],
            dependencies: [ 'locale', 'jquery' ]
        },
        rdcpui: {
            js: [ 'src/ui/rdcp.window.js', 'src/ui/rdcp.tree.js', 'src/ui/rdcp.grid.js', 'src/ui/rdcp.dateBox.js',
        ...
        numeral: {
            js: ['lib/numeral/numeral.min.js','lib/numeral/languages.min.js']
        }
    },
