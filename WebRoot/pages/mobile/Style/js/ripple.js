...
// 	var colour = "#000000";
// 	var opacity = 0.1;
// 	var ripple_within_elements = ['input', 'button', 'a','img'];
...
// 			$element.style.background = "-webkit-radial-gradient(" + colour + " 64%, rgba(0,0,0,0) 35%) no-repeat";
// 			$element.style.background = "radial-gradient(" + colour + " 64%, rgba(0,0,0,0) 35%) no-repeat";
