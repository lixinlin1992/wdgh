...
$(function(){			
	//生成校验规则列表
	GRID.create("#listdt","DS_ONLINE_USER_HISTORY_LIST",menuGridParams,"gridParam");
});
//规则添加
function ruleAdd(){
							...
							<div class="barquerycontent" style="width: 100%">					
								<table class="content_List" style="width: 100%">
									<tr>
										...
										<td>																	
											开始:<input type='text' name='startTime' id='startTime' class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-mm-dd'});" readonly="readonly"/>
										</td>
										<td>
											结束:<input type='text' name='endTime' class="Wdate" id='endTime' onfocus="WdatePicker({dateFmt:'yyyy-mm-dd'});" readonly="readonly"/>
										</td>										
										<td>
